...
hl.bind("CTRL + SUPER + V", hl.dsp.global("quickshell:overviewClipboardToggle"))
...
hl.bind("SUPER + ALT + H", hl.dsp.global("quickshell:barToggle"), { description = "Shell: Toggle bar" })
...
hl.bind("", hl.dsp.exec_cmd(grimhyprctl .. " - | wl-copy"),
...
for i = 1, 4 do
    ...
    hl.bind("SUPER + " .. vimkey[i], hl.dsp.focus({ direction = focusdir[i] }),
        { description = "Window: Focus " .. focusdir[i] })
end
for i = 1, 2 do
...
for i = 1, 4 do
    local vimkey = { "H", "L", "K", "J" }
    local focusdir = { "l", "r", "u", "d" }
    hl.bind("SUPER + SHIFT + " .. vimkey[i], hl.dsp.window.move({ direction = focusdir[i] }),
        { description = "Window: Move " .. focusdir[i] })
end
...
--# Positioning mode
hl.bind("SUPER + W + Space", hl.dsp.window.float({ action = "toggle" }), { description = "Window: Float/Tile" })
...
hl.bind("SUPER + V", hl.dsp.exec_cmd(browser), { description = "App: Browser" })
...
hl.bind("", hl.dsp.exec_cmd(volumeMixer), { description = "App: Volume mixer" })
